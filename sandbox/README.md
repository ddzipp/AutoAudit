To deploy the sandbox django project, one should install all packages required in the project. Especially, `clamAV` should be added to the environment path.
